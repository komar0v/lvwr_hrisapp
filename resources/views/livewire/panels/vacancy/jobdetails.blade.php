                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="updateJobData('{{$jobData['id']}}')">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div id="inputFormRow" class="inputFormRow">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="key[]" readonly value="{{ $jobReq }}" class="form-control" placeholder="have minimal one year work experience">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input wire:model="jobRequirements" type="hidden" name="jobRequirements" value="" id="jobRequirements">
                                        <input wire:model="jobDescription" type="hidden" name="jobDescription" value="" id="jobDescription">
                                        <button type="submit" id="submitButton" class="btn btn-primary">Save Changes
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#addRow").click(function() {
                ...
                html += '<input type="text" name="key[]" value="" class="form-control" placeholder="have minimal one year work experience">';
            ...
            $(document).on('click', '.removeRow', function() {
                ...
                jobRequirementsLivewire.delete(removedKey); // Remove the key from the Set
            ...
            $(document).on('blur', 'input[name="key[]"]', function() {
                ...
                // Remove the old value and add the new value to the set
